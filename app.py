...
perplexity_threshold = st.sidebar.number_input("Perplexity Threshold", min_value=1.0, value=30000.0, step=1.0)
burstiness_threshold = st.sidebar.number_input("Burstiness Threshold", min_value=0.0, max_value=1.0, value=0.2, step=0.01)
